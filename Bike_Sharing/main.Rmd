...
main$flag.combined <- (data$station1[-1] == data$station2[-nrow(data)]) & 
                      (data$bike[-1] == data$bike[-nrow(data)])
...
__`r sum(main$flag.combined & as.numeric(main$tdiff) > 0)`__.
...
At any rate, the __mean time spent by a bike at a station__ is __`r ss[4]`__, 
