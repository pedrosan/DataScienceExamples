...
As described in the paper by [Velloso et al.](http://groupware.les.inf.puc-rio.br/work.jsf?p1=11201), 

* four _inertial measurement units_ (IMU) where setup, placed  on _belt_, _arm_, _forearm_, _dumbbell_.
...
```{r plots-examine2b, fig.width = 6, fig.height = 6, echo = TRUE}
df <- alt.full
#   8 = roll_belt
#   9 = pitch_belt
#  10 = yaw_belt
...
<button class="toggle_plot_code">show plot code</button>
```{r plots-examine2c, fig.width = 6, fig.height = 6, echo = TRUE}
df <- alt.full
#   8 = roll_belt
#   9 = pitch_belt
#  10 = yaw_belt
...
<button class="toggle_plot_code">show plot code</button>
```{r plots-more_1, fig.width = 6, fig.height = 6, echo = TRUE}
df <- alt.full.select 
...
<button class="toggle_plot_code">show plot code</button>
```{r plots-more_2, fig.width = 6, fig.height = 6, echo = TRUE}
df <- alt.full.select 
