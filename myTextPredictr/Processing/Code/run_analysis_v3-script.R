...
in.blogs.CL.cleaned <- gsub('<(emoticon|space>|hashtag|dollaramount|period|hour|profanity|usa|percentage|date|money|ass|space)>', 
                  '<\\U\\1>', in.blogs.CL.cleaned, ignore.case = TRUE, perl = TRUE)

in.news.CL.cleaned <- gsub('<(emoticon|space>|hashtag|dollaramount|period|hour|profanity|usa|percentage|date|money|ass|space)>', 
                  '<\\U\\1>', in.news.CL.cleaned, ignore.case = TRUE, perl = TRUE)

in.twitter.CL.cleaned <- gsub('<(emoticon|space>|hashtag|dollaramount|period|hour|profanity|usa|percentage|date|money|ass|space)>', 
                  '<\\U\\1>', in.twitter.CL.cleaned, ignore.case = TRUE, perl = TRUE)

# gsub("<emoticon>", "<EMOTICON>", in.blogs.CL.cleaned, perl = TRUE)
# gsub("<space>", "<SPACE>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<hashtag>", "<HASHTAG>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<dollaramount>", "<DOLLARAMOUNT>", in.blogs.CL.cleaned, perl = TRUE)
# gsub("<period>", "<PERIOD>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<hour>", "<HOUR>", in.blogs.CL.cleaned, perl = TRUE)
# gsub("<profanity>", "<PROFANITY>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<usa>", "<USA>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<percentage>", "<PERCENTAGE>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<date>", "<DATE>", in.blogs.CL.cleaned, perl = TRUE)
# gsub("<money>", "<MONEY>", in.blogs.CL.cleaned, perl= TRUE)
# gsub("<ass>", "<ASS>", in.blogs.CL.cleaned, perl= TRUE)

# gsub("<emoticon>", "<EMOTICON>", in.news.CL.cleaned, perl = TRUE)
# gsub("<space>", "<SPACE>", in.news.CL.cleaned, perl= TRUE)
# gsub("<hashtag>", "<HASHTAG>", in.news.CL.cleaned, perl= TRUE)
# gsub("<dollaramount>", "<DOLLARAMOUNT>", in.news.CL.cleaned, perl = TRUE)
# gsub("<period>", "<PERIOD>", in.news.CL.cleaned, perl= TRUE)
# gsub("<hour>", "<HOUR>", in.news.CL.cleaned, perl = TRUE)
# gsub("<profanity>", "<PROFANITY>", in.news.CL.cleaned, perl= TRUE)
# gsub("<usa>", "<USA>", in.news.CL.cleaned, perl= TRUE)
# gsub("<percentage>", "<PERCENTAGE>", in.news.CL.cleaned, perl= TRUE)
# gsub("<date>", "<DATE>", in.news.CL.cleaned, perl = TRUE)
# gsub("<money>", "<MONEY>", in.news.CL.cleaned, perl= TRUE)
# gsub("<ass>", "<ASS>", in.news.CL.cleaned, perl= TRUE)

# gsub("<emoticon>", "<EMOTICON>", in.twitter.CL.cleaned, perl = TRUE)
# gsub("<space>", "<SPACE>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<hashtag>", "<HASHTAG>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<dollaramount>", "<DOLLARAMOUNT>", in.twitter.CL.cleaned, perl = TRUE)
# gsub("<period>", "<PERIOD>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<hour>", "<HOUR>", in.twitter.CL.cleaned, perl = TRUE)
# gsub("<profanity>", "<PROFANITY>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<usa>", "<USA>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<percentage>", "<PERCENTAGE>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<date>", "<DATE>", in.twitter.CL.cleaned, perl = TRUE)
# gsub("<money>", "<MONEY>", in.twitter.CL.cleaned, perl= TRUE)
# gsub("<ass>", "<ASS>", in.twitter.CL.cleaned, perl= TRUE)
...
# rn.blogs <- rn.blogs.CL[1:22643]
# in.blogs <- in.blogs.CL.cleaned[1:22643]
# rn.news <- rn.news.CL[1:27643]
# in.news <- in.news.CL.cleaned[1:27643]
# rn.twitter <- rn.twitter.CL[1:32643]
# in.twitter <- in.twitter.CL.cleaned[1:32643]

# rn.blogs <- rn.blogs.CL[1:10643]
# in.blogs <- in.blogs.CL.cleaned[1:10643]
# rn.news <- rn.news.CL[1:13643]
# in.news <- in.news.CL.cleaned[1:13643]
# rn.twitter <- rn.twitter.CL[1:18643]
# in.twitter <- in.twitter.CL.cleaned[1:18643]
